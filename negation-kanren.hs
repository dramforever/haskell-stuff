...
{-
(#5,[#3 :/=. [#11],#5 :==. res[#9,#3,#11],#9 :==. c[#6,#10],#10 :==. n,#11 :==. c[#6,#3]])
(#5,[#3 :/=. [#16],#5 :==. res[#9,#3,#16],#9 :==. c[#6,#13],#13 :==. c[#10,#14],#14 :==. n,#15 :==. c[#10,#3],#16 :==. c[#6,#15]])
(#5,[#3 :/=. [#21],#5 :==. res[#9,#3,#21],#9 :==. c[#6,#13],#13 :==. c[#10,#17],#17 :==. c[#14,#18],#18 :==. n,#19 :==. c[#14,#3],#20 :==. c[#10,#19],#21 :==. c[#6,#20]])
(#5,[#3 :/=. [#26],#5 :==. res[#9,#3,#26],#9 :==. c[#6,#13],#13 :==. c[#10,#17],#17 :==. c[#14,#21],#21 :==. c[#18,#22],#22 :==. n,#23 :==. c[#18,#3],#24 :==. c[#14,#23],#25 :==. c[#10,#24],#26 :==. c[#6,#25]])
(#5,[#3 :/=. [#31],#5 :==. res[#9,#3,#31],#9 :==. c[#6,#13],#13 :==. c[#10,#17],#17 :==. c[#14,#21],#21 :==. c[#18,#25],#25 :==. c[#22,#26],#26 :==. n,#27 :==. c[#22,#3],#28 :==. c[#18,#27],#29 :==. c[#14,#28],#30 :==. c[#10,#29],#31 :==. c[#6,#30]])
-}